	...
	UPackage* Z_Construct_UPackage__Script_SomeTool()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_SomeTool_OnHitDelegate__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_SomeTool_OnRotateDelegate__DelegateSignature,
			};
