...
public:
	...
	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category="SomeTool|LevelLayout", meta=(DisplayName="房间范围组件"))
	TObjectPtr<UBoxComponent> RoomBoundsComponent;

	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category="SomeTool|LevelLayout", meta=(DisplayName="房间ID预览组件"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SomeTool|LevelLayout", AdvancedDisplay, meta=(DisplayName="使用显式房间ID"))
	bool bUseExplicitRoomId = false;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SomeTool|LevelLayout", AdvancedDisplay, meta=(EditCondition="bUseExplicitRoomId", EditConditionHides, DisplayName="显式房间ID"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SomeTool|LevelLayout", meta=(DisplayName="优先级", ToolTip="多个房间工具重叠时，优先级更高的会覆盖更低的。"))
	int32 Priority = 0;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SomeTool|LevelLayout", meta=(DisplayName="吸附到布局网格"))
	bool bSnapToLayoutGrid = true;

	UPROPERTY(VisibleInstanceOnly, BlueprintReadOnly, Category="SomeTool|LevelLayout", meta=(DisplayName="当前房间ID"))
