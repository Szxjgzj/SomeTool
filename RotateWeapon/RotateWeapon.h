...
class SOMETOOL_API URotateWeapon : public UInstancedStaticMeshComponent
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable)
	void UpdateInstanceLocation(int32 Index,float Radius = 500.f,float Angle = 0.f,FVector Size = FVector(1,1,1),float YawDelta = 0.f);
